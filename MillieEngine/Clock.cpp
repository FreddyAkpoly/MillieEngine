...
namespace me
{
	...
	// to Return time elapsed since delta was last called. -1 if error. Resets previous time to current time
	...
	// to return time elapsed since delta was called, -1 if error.Does not reset previous time
